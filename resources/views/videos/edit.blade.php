                ...
                <form action="{{route('videos.update',$video->slug)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input name="name" value="{{$video->name}}" type="text" class="form-control"
                                   placeholder="@lang('videos.name')">
                        </div>
                        <div class="col-md-6">
                            <label>@lang('videos.length')</label>
                            <input type="text" name="length" value="{{$video->length}}" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="thumbnail" value="{{$video->thumbnail}}" class="form-control"
